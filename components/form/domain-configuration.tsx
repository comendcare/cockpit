        ...
        <div className="border-t border-stone-200 px-10 pb-5 pt-7 dark:border-stone-700">
            ...
            {txtVerification ? (
                <>
                    ...
                    <div
                        className="my-5 flex items-start justify-start space-x-10 rounded-md bg-stone-50 p-2 dark:bg-stone-800 dark:text-white">
                        <div>
                ...
                <>
                    ...
                    <div className="my-3 text-left">
                        ...
                        <div
                            className="flex items-center justify-start space-x-10 rounded-md bg-stone-50 p-2 dark:bg-stone-800 dark:text-white">
                            <div>
                                <p className="text-sm font-bold">Type</p>
